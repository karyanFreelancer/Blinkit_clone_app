...
var ToastImpl = /* @__PURE__ */React.forwardRef(function (props, forwardedRef) {
  ...
  var context = useToastProviderContext(scope);
  var [node, setNode] = React.useState(null);
  var composedRefs = useComposedRefs(forwardedRef, setNode);
  ...
  var handleClose = useEvent(function () {
    if (!isPresent) {
      return;
    }
    if (isWeb) {
  ...
  var AnimatedView = (_ref = (_animationDriver_NumberView = animationDriver["NumberView"]) !== null && _animationDriver_NumberView !== void 0 ? _animationDriver_NumberView : animationDriver.View) !== null && _ref !== void 0 ? _ref : View;
