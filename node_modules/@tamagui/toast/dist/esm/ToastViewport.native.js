...
var ToastViewportWrapperFrame = styled(YStack, {
...
var ToastViewportFrame = styled(YStack, {
  name: VIEWPORT_NAME,
  variants: {
    unstyled: {
      false: {
...
var ToastViewport = /* @__PURE__ */React.memo(/* @__PURE__ */React.forwardRef(function (props, forwardedRef) {
  ...
  var getItems = useCollection(scope || TOAST_CONTEXT);
  ...
  var composedRefs = useComposedRefs(forwardedRef, ref, onViewportChange);
  ...
  if (portalToRoot) {
    return /* @__PURE__ */_jsx(ToastPortal, {
      context,
