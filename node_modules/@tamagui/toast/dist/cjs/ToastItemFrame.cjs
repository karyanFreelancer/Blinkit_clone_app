...
const ToastItemFrame = (0, import_core.styled)(import_stacks.YStack, {
  name: "ToastItem",
  userSelect: "none",
  cursor: "default",
  focusable: true,
...
const ToastCloseFrame = (0, import_core.styled)(import_stacks.XStack, {
  name: "ToastClose",
  render: "button",
  alignItems: "center",
...
const ToastActionFrame = (0, import_core.styled)(import_stacks.XStack, {
  name: "ToastAction",
  render: "button",
  alignItems: "center",
  justifyContent: "center",
...
const DefaultCloseIcon = () => /* @__PURE__ */(0, import_jsx_runtime.jsx)(import_text.SizableText, {
  size: "$1",
  color: "$color11",
  children: "\u2715"
});