...
var ToastAnnounceExcludeFrame = (0, import_core.styled)(import_core.View, {
...
var ToastAnnounce = function (props) {
  ...
  var [renderAnnounceText, setRenderAnnounceText] = React.useState(false);
  var [isAnnounced, setIsAnnounced] = React.useState(false);
  ...
  return isAnnounced ? null : /* @__PURE__ */(0, import_jsx_runtime.jsx)(import_portal.Portal, {
...
function useNextFrame() {
  ...
  var fn = (0, import_core.useEvent)(callback);
