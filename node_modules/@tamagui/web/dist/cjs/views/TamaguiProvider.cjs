...
var import_TamaguiRoot = require("./TamaguiRoot.cjs");
...
function TamaguiProvider({
  ...
  if ((0, import_config.getSetting)("disableSSR")) contents = /* @__PURE__ */(0, import_jsx_runtime.jsx)(import_use_did_finish_ssr.ClientOnly, {
    enabled: true,
    children: contents
  });
