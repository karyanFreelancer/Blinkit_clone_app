...
var import_isTamaguiComponent = require("./isTamaguiComponent.cjs");
const isTamaguiElement = (child, name) => {
  return import_react.default.isValidElement(child) && (0, import_isTamaguiComponent.isTamaguiComponent)(child.type, name);
};