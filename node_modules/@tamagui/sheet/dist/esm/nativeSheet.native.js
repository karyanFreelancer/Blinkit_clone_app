...
function setupNativeSheet(platform, RNIOSModal) {
  ...
  if (platform === "ios") {
    nativeSheets[platform] = function (props) {
      ...
      useEffect(function () {
        if (open) {
          var _ref_current;
          (_ref_current = ref.current) === null || _ref_current === void 0 ? void 0 : _ref_current.presentModal();
        } else {
          var _ref_current1;
          (_ref_current1 = ref.current) === null || _ref_current1 === void 0 ? void 0 : _ref_current1.dismissModal();
        }
      }, [open]);
      function setOpenInternal(next) {
        var _props_onOpenChange;
        (_props_onOpenChange = props.onOpenChange) === null || _props_onOpenChange === void 0 ? void 0 : _props_onOpenChange.call(props, open);
        setOpen(next);
      }
