  ...
  function transformChildren(menu, map, children) {
    ...
    React.Children.forEach(children, function (child) {
      ...
      if (isPortalLike(displayName)) {
        var inner = transformChildren(menu, map, props.children, false);
      ...
      if (displayName.includes("ScrollView")) {
        var inner1 = transformChildren(menu, map, props.children, false);
      ...
      if (componentType === "CheckboxItem") {
        ...
        var cleanChildren = React.Children.map(cbChildren, function (c) {
          var _c_type;
